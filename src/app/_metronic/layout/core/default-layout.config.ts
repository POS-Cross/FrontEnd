...
export const DefaultLayoutConfig: ILayout =  
{"main":{
  "componentName":"main","type":"default","primaryColor":"#009EF7","darkSkinEnabled":true},
  "loader":{"componentName":"loader","display":true,"type":"default"},
  "scrolltop":{"componentName":"scroll-top","display":true},
  "header":{"componentName":"header","display":true,"width":"fixed","left":"page-title","fixed":{"desktop":true,"tabletAndMobile":true},"menuIcon":"svg"},
  "megaMenu":{"componentName":"mega-menu","display":true},
  "aside":{"componentName":"aside","display":true,"theme":"light","menu":"main","fixed":false,"minimized":false,"minimize":false,"hoverable":false,"menuIcon":"svg"},
  "content":{"componentName":"content","width":"fixed","layout":"default"},
  "toolbar":{"componentName":"toolbar","display":false,"width":"fixed",
  "fixed":{"desktop":true,"tabletAndMobileMode":true},"layout":"toolbar1",
  "layouts":{"toolbar1":{"height":"55px","heightAndTabletMobileMode":"55px"},
  ...
  "pageTitle":{"componentName":"page-title","display":true,"breadCrumbs":true,"description":false,"layout":"default","direction":"row","responsive":true,"responsiveBreakpoint":"lg","responsiveTarget":"#kt_toolbar_container"}};
